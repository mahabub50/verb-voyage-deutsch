...
export const additionalVerbGroups3: VerbGroup[] = [
  {
    ...
    verbs: [
      {
        verb: "vorfahren",
        translation: "to drive up, to have right of way",
      ...
      {
        verb: "vorfinden",
        translation: "to find, to encounter",
      ...
      {
        verb: "vorführen",
        translation: "to demonstrate, to perform",
      ...
      {
        verb: "vorgeben",
        translation: "to pretend, to specify",
      ...
      {
        verb: "vorgehen",
        translation: "to proceed, to advance",
      ...
      {
        verb: "vormachen",
        translation: "to demonstrate, to deceive",
      ...
      {
        verb: "vornehmen",
        translation: "to undertake, to plan",
      ...
      {
        verb: "vorschlagen",
        translation: "to suggest, to propose",
      ...
      {
        verb: "vorschreiben",
        translation: "to prescribe, to dictate",
      ...
      {
        verb: "vorsehen",
        translation: "to provide for, to plan",
      ...
      {
        verb: "vortragen",
        translation: "to present, to perform",
  ...
  },
  {
    ...
    verbs: [
      ...
      {
        verb: "wegfallen",
        translation: "to be omitted, to be canceled",
      ...
      {
        verb: "weglassen",
        translation: "to leave out, to omit",
      ...
      {
        verb: "wegmachen",
        translation: "to remove, to get rid of",
  ...
  {
    prefix: "weiter",
    description: "further, continue",
    verbs: [
      {
        verb: "weiterarbeiten",
        translation: "to continue working",
      ...
      {
        verb: "weiterbringen",
        translation: "to advance, to help progress",
      ...
      {
        verb: "weiteressen",
        translation: "to continue eating",
      ...
      {
        verb: "weiterleben",
        translation: "to continue living",
      ...
      {
        verb: "weiterreden",
        translation: "to continue talking",
      ...
      {
        verb: "weitersagen",
        translation: "to pass on, to tell others",
      ...
      {
        verb: "weitersehen",
        translation: "to see what happens next",
      ...
      {
        verb: "weiterspielen",
        translation: "to continue playing",
      ...
      {
        verb: "weitersprechen",
        translation: "to continue speaking",
      ...
      {
        verb: "weitersuchen",
        translation: "to continue searching",
  ...
  {
    prefix: "wett",
    description: "compete, bet",
    verbs: [
      {
        verb: "wettlaufen",
        translation: "to race, to compete in running",
      ...
      {
        verb: "wettmachen",
        translation: "to make up for, to compensate",
  ...
  },
  {
    ...
    verbs: [
      ...
      {
        verb: "zudrehen",
        translation: "to turn off, to close",
      ...
      {
        verb: "zugehen",
        translation: "to approach, to close",
      ...
      {
        verb: "zugreifen",
        translation: "to grab, to help oneself",
      ...
      {
        verb: "zuhaben",
        translation: "to be closed, to have closed",
      ...
      {
        verb: "zusehen",
        translation: "to watch, to see to it",
      ...
      {
        verb: "zustimmen",
        translation: "to agree, to consent",
      ...
      {
        verb: "zustoßen",
        translation: "to happen to, to befall",
  ...
  {
    prefix: "zurecht",
    description: "right, in order",
    verbs: [
      {
        verb: "zurechtfinden",
        translation: "to find one's way, to cope",
      ...
      {
        verb: "zurechtmachen",
        translation: "to prepare, to get ready",
      ...
      {
        verb: "zurechtweisen",
        translation: "to reprimand, to correct",
  ...
  },
  {
    ...
    verbs: [
      {
        verb: "zurückblättern",
        translation: "to turn back pages",
      ...
      {
        verb: "zurücktreten",
        translation: "to step back, to resign",
  ...
  },
  {
    ...
    verbs: [
      ...
      },
      {
        ...
        translation: "to squeeze together",
      ...
      },
      {
        ...
        translation: "to belong together",
      ...
      {
        verb: "zusammenlaufen",
        translation: "to converge, to meet",
      ...
      {
        verb: "zusammenpassen",
        translation: "to match, to fit together",
      ...
      },
      {
        ...
        translation: "to clap together, to beat up",
      ...
      },
      {
        ...
        translation: "to unite, to join forces",
      ...
      {
        verb: "zusammensetzen",
        translation: "to assemble, to put together",
      ...
      },
      {
        ...
        translation: "to put together, to compile",
  ...
  {
    prefix: "zwischen",
    description: "between, among",
    verbs: [
      {
        verb: "zwischenlagern",
        translation: "to store temporarily",
      ...
      },
      {
        ...
        translation: "to cache, to store temporarily",
